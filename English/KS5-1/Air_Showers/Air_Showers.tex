...
\includegraphics[scale=0.6]{spectrum}%
...
\begin{figure}\begin{center}
\includegraphics[scale=0.38]{shower}%
...
\begin{figure}\begin{center}
\includegraphics[scale=0.45]{shower_density}%
...
\begin{figure}\begin{center}
\includegraphics[scale=0.5]{x_max}%
...
\begin{figure}\begin{center}
\includegraphics[scale=0.5]{profile2}%
...
\begin{figure}\begin{center}
\includegraphics[scale=0.5]{profile3}%
...
\begin{figure}\begin{center}
\includegraphics[scale=0.5]{profile_flux}%
