...
\includegraphics[scale=0.45]{shower_angles}
...
\begin{figure}\begin{center}
\includegraphics[scale=0.45]{shower_surfaces}
...
\includegraphics[scale=0.25]{crosssection_bA}
...
\begin{figure}\begin{center}
\includegraphics[scale=0.4]{slope}
...
\begin{figure}\begin{center}
\includegraphics[scale=0.4]{distances}
