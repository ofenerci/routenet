...
In \figref{fig:Energie-en-golfvergelijking} zijn de energie en
...
Hierbij gaat een magneetveldje gepaard (zie \figref{fig:Spin}).


\paragraph*{Opdracht 5:}

\emph{Leg uit wat N en S in \figref{fig:Spin} betekenen. Teken de veldlijnen.}
...
de 1s orbitaal. In \figref{fig:Orbitalen} zijn de orbitalen van
de verschillende banen getekend. De bijbehorende energieniveaus zijn
in \figref{fig:Energieniveaux}.
...
worden afgestaan. Dit wordt emissie genoemd. De pijlen in \figref{fig:Energieniveaux}
...
In \figref{fig:Singulet-en-triplet} is het energiediagram van
...
\emph{Leg \figref{fig:Verval-in-He} uit.}

Het energiediagram in \figref{fig:Verval-in-Anthraceen} geeft
