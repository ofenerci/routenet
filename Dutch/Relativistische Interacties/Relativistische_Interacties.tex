...
In deze 
module wordt de beschrijving van de botsing (interactie) met behulp van energie 
...
deeltje neemt toe met de Lorentzfactor $\gamma$ als de snelheid toeneemt. 
Deze factor is te schrijven als: 
