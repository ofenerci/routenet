...
\end{tabular}
\par\end{center}
\textsf{Door de toestandvectoren van beide fotonen op te tellen is de begintoestand van het systeem te bepalen (rood / paralellogrammethode). Er is precies voldoende energie voor de creatie van een deeltje (blauw) en een anti-deeltje (groen) in de eindtoestand, beide met een massa 1 (kop-staartmethode).
