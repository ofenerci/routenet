...
Deeltjes kunnen interacties met elkaar aangaan als ze 
...
is net als de rustmassa $m$ voor iedere waarnemer hetzelfde. Dit worden ook invariante grootheden
genoemd.%
...
Zoals gezegd is de rustmassa $m$ in formule \ref{eq:s} invariant. Als een deeltje
in rust is, meet iedere waarnemer dus dezelfde massa. De energie $E$
en de impuls $p$ bepalen de toestand van deze massa. Deze rustmassa kan uit
een enkel deeltje of uit diverse deeltjes bestaan.
\end{multicols}
