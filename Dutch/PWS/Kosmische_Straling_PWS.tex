...
\section{Een kosmische straling profielwerkstuk}

In een kosmische straling profielwerkstuk wordt uiteraard kosmische
straling bestudeerd. Dit onderzoek kan zich richten op:
\begin{itemize}
\item Bronnen van kosmische straling.
\item Effecten van kosmische straling.
\item Afbuigen van kosmische straling, geladen deeltjes in een magnetisch
veld.\end{itemize}
