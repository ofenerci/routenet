...
In het $\left(p,E\right)$-diagram in \figref{fig:(p,E)-diagram}
...
Zoals in \figref{fig:voldoende} te zien is, kunnen de toestanden van beide fotonen met twee $\left(p, 
...
Een overschot aan energie verandert het diagram, het deeltje en het anti-deeltje krijgen nu ook een extra impuls. Deze diagrammen zijn te zien in \figref{fig:overschot}
