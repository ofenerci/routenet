...
Een draaiend vat verdraaid voor alle punten altijd een zelfde hoek.
De snelheid van een punt en de straal van het punt zijn rechtevenredig.
We introduceren een nieuwe grootheid de hoeksnelheid $\omega$. Deze
kan in graden per seconde, maar liever in radialen%
\footnote{Een cirkel heeft $360^{o}$ of $2\pi$ radialen. 1 radiaal is dus
$\frac{360^{o}}{2\pi}$.%
